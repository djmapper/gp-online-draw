...
define(["dojo/ready", "dojo/_base/declare", "dojo/_base/lang",
  ...
  "esri/arcgis/utils", "dijit/form/Button", "dojo/dom", "dojo/dom-class"
  ...
  return declare(null, {
	...
	/* var btnApplyRenderer = new Button({
        label : "Click here to analyse landcover",
	...
	function initDrawTool() {
       ...
       */
	  dom.byId("btnLanduse").innerHTML = "Draw a polygon on the map" 
      tbDraw = new Draw(map);
	...
	function displayPolygon(evt) {
	  ...
	  tbDraw.deactivate()
	  //Update Button
	  dom.byId("btnLanduse").innerHTML = "Calculating landcover ...."
      // Call the next function
      runAnalysis(graphicPolygon);
    }

      function runAnalysis(graphicPolygon) {
        ...
        featureSet.features = [graphicPolygon];
        //define gp task
        gp = new Geoprocessor(
	...
	dom.byId("btnLanduse").innerHTML = "Click here to analyse a new area" 
